...
{	
	...
	*/
	...
	//index = fmod(index, SINE_TABLE_SIZE); //if index is equal or greater to 256 it must be wrapped around, as index is not necessarily an integer, the fmod function is employed
